 ...
 IsDelay:='0';
  ...
  //    if  (FormatDateTime('yyyy-mm-dd',qry.FieldByName('ShippingDate').asdatetime)>'')
     //    and  (FormatDateTime('yyyy-mm-dd',qry.FieldByName('EstimateDate').asdatetime)>'') then
        //if  (formatdatetime('yyyy-mm-dd',qry.FieldByName('ShippingDate').asdatetime)>'1900-01-01')
          // and  ('yyyy-mm-dd',formatdatetime(qry.FieldByName('EstimateDate').asdatetime>'1900-01-01') then
      if  (ShippingDate>'1900-01-01')
          and  (EstimateDate>'1900-01-01') then
