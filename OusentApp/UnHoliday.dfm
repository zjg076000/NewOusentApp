inherited FrmHoliday: TFrmHoliday
  ...
  object adt: TADODataSet
    ...
    CursorType = ctStatic
    CommandText = 
      ' select   c.PCode,c.PName,b.DeptName,a.*  FROM '#13#10'Hrm_Leave a  le' +
      'ft   join   Hrm_Dept b   on   a.DeptId=b.DeptId'#13#10'left   join   H' +
      'rm_Person c   on   a.PersonId=c.PersonId WHERE  DateDiff(dd,a.On' +
      'Date,getdate())=0'
    Parameters = <>
    Left = 64
    Top = 263
    ...
    object adtLeave_Date: TDateTimeField
